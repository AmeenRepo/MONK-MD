...
var xeonytimewisher = `Good Morning🌝`
 ...
 if(time2 < "05:00:00"){
var xeonytimewisher = `*Monk-MD Running 24 Hours*`
 } 
module.exports = XeonBotInc = async (XeonBotInc, m, msg, chatUpdate, store) => {
    try {
        ...
        const pushname = m.pushName || "Ameen-Ser"
...
"previewType": "PHOTO",
"AmeennailUrl": ``,
"Ameennail": fs.readFileSync(`./Media/Ameen-Ser.jpg`),
"sourceUrl": `${link}`}}},
{ quoted: m})
}
...
let { key } = await XeonBotInc.sendMessage(from, {text: '_Loading Please Wait..._'})
...
senddocu(buffer)
        ...
        switch (command) {
            ...
            case 'shutdown':
                if (!isCreator) return replygcxeon(mess.owner)
                replygcxeon(`_*MONK-MD DEACTIVATED✅*_`)
                await sleep(3000)
                process.exit()
                break
            case 'restart':
                if (!isCreator) return replygcxeon(mess.owner)
                replygcxeon('_*MONK-MD ACTIVATED✅*_')
                ...
                for (let i of anu) {
                    ...
                    XeonBotInc.sendMessage(i, {
                        ...
                        contextInfo: {
                            externalAdReply: {
                                showAdAttribution: true,
                                title: 'Broadcast By Ameen-Ser',
                                body: `Sent ${i.length} Group`,
                                AmeennailUrl: 'https://i.imgur.com/8TH8EU4.jpeg',
                                sourceUrl: global.link,
                                mediaType: 1,
                                renderLargerAmeennail: true
                            }
                        }
                    })
                }
            ...
            case 'getcase':
                if (!isCreator) return replygcxeon(mess.owner)
                const getCase = (cases) => {
                    return "case" + `'${cases}'` + fs.readFileSync("MONK-MD.js").toString().split('case \'' + cases + '\'')[1].split("break")[0] + "break"
                }
...
`.trim()
            ...
            break
            case 'runtime':
                let runtimetext = `*MONK MD RUNNING TIME:* ${runtime(process.uptime())}`
                XeonBotInc.sendMessage(m.chat, {
                    text: runtimetext,
                    contextInfo: {
                        externalAdReply: {
            ...
            case 'git':
                XeonBotInc.sendMessage(m.chat, {
                    text: `*📍AMEEN-SER:* https://github.com/AmeenRepo`,
                    contextInfo: {
                        externalAdReply: {
                            showAdAttribution: true,
                            title: `AMEEN-SER`,
                            body: `🖤BOT CODED BY AMEEN-SER🤍`,
                            AmeennailUrl: 'https://i.imgur.com/8TH8EU4.jpeg',
                            sourceUrl: global.link,
                            mediaType: 1,
                            renderLargerAmeennail: true
...
if (!args.join(" ")) return replygcxeon(`Where is the text? Monk Md Is Confused`)
const swn = args.join(" ")
...
break
      ...
      case 'qc': {
                ...
                let ppnyauser = await await XeonBotInc.profilePictureUrl(m.sender, 'image').catch(_ => 'https://i.imgur.com/8TH8EU4.jpeg')
...
await XeonBotInc.sendMessage(m.chat,{
    ...
    contextInfo:{
        externalAdReply:{
            title:anup3k.title,
            body: botname,
            Ameennail: await fetchBuffer(pl.meta.image),
            mediaType:2,
            mediaUrl:anup3k.url,
        }
...
await XeonBotInc.sendMessage(m.chat,{
    ...
    contextInfo:{
        externalAdReply:{
            ...
            body: botname,
            Ameennail: await fetchBuffer(audio.meta.image),
            mediaType:2,
            mediaUrl:text,
        }
...
replygcxeon(`*Successfully sent as many AMEEN-SER as ${amount} Please pause for 3 minutes*`)
break
case 'pmbug' :{
 if (!isPremium) return replygcxeon(mess.prem)
 if (!args[0]) return replygcxeon(`Use ${prefix+command} number\nExample ${prefix+command} 916238768108`)
...
"surface": "CATALOG",
"message": `${botname}`,
"orderTitle": "🖤CREATED BY AMEEN🤍", 
"sellerJid": "916238768108@s.whatsapp.net",
...
case 'gcbug' : {
if (!isPremium) return replygcxeon(mess.prem)
 if (!args[0]) return replygcxeon(`Use ${prefix+command} link\nExample ${prefix+command} https://chat.whatsapp.com/AnMnEbEhN`)
await loading()
let result = args[0].split('https://chat.whatsapp.com/')[1]
...
case 'delaygcbug' :  {
if (!isPremium) return replygcxeon(mess.prem)
if (!args[0]) return replygcxeon(`Use ${prefix+command} link\nExample ${prefix+command} https://chat.whatsapp.com/AgMyEjEvNgSgEhR`)
await loading()
let result = args[0].split('https://chat.whatsapp.com/')[1]
let xeongc = await XeonBotInc.groupAcceptInvite(result)
amount = "30"
...
case 'labug' :  {
if (!isPremium) return replygcxeon(mess.prem)
if (!args[0]) return replygcxeon(`Use ${prefix+command} link\nExample ${prefix+command} https://chat.whatsapp.com/JVKKTg3rmmig`)
await loading()
let result = args[0].split('https://chat.whatsapp.com/')[1]
let xeongc = await XeonBotInc.groupAcceptInvite(result)
amount = "30"
...
case 'tlybug' :  {
if (!isPremium) return replygcxeon(mess.prem)
if (!args[0]) return replygcxeon(`Use ${prefix+command} link\nExample ${prefix+command} https://chat.whatsapp.com/JVKKTg3rBVplg`)
await loading()
let result = args[0].split('https://chat.whatsapp.com/')[1]
let xeongc = await XeonBotInc.groupAcceptInvite(result)
amount = "15"
...
"surface": "CATALOG",
"message": `${botname}`,
"orderTitle": "MONK MD TROLLEY BUG", 
"sellerJid": "916238768108@s.whatsapp.net",
"token": "AR6z9PAvHjs9Qa7AYgBUjSEvcnOcRWycFpwieIhaMKdrhQ=="
}
}), { userJid: from, quoted:m})
...
if (typemenu === 'v1') {
                    XeonBotInc.sendMessage(m.chat, {
                        image: fs.readFileSync('./Media/Ameen-Ser.jpg'),
                        caption: xeonmenuoh
                    }, {
                        quoted: m
                    })
                    ...
                    XeonBotInc.sendMessage(m.chat, {
                        video: fs.readFileSync('./Media/Ameen.mp4'),
                        caption: xeonmenuoh,
                        gifPlayback: true
                    }, {
                        quoted: m
